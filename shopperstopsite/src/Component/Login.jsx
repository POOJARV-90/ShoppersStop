  ...
  return (
   ...
   <div id='log-body'> 
        ...
        <form onSubmit={handleSubmit}>
           ...
           <input type="email" onChange={hangleChange} name='email' placeholder='Email*'  />  <br />

           {/* <label htmlFor="">Password</label> */}
           <input type='password' onChange={hangleChange } name='password' placeholder='Password *'/>  <br />
